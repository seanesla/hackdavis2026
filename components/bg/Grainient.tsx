...
const Grainient = ({
  ...
  // Mutable refs for live-updating uniforms without re-creating GL context.
  ...
  useEffect(() => {
    ...
    const loop = (t: number) => {
      ...
      u.uCenterOffset.value[0] = p.centerX;
      u.uCenterOffset.value[1] = p.centerY;
    ...
    // Intentionally empty deps: GL context is created once and uniforms
    // are updated each frame from propsRef.
